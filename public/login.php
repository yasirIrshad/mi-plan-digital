...
<body class="fixed-left">
    <div id="appLogin" style="height: 100vh; display: flex; justify-content: center;">
        ...
        <!-- Begin page -->
        <div class="" style="align-self: center; height: 700px">
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                <div class="p-2">
                                    <div class="d-flex justify-content-center mb-5 pb-5">
                                        <a href="index.html" class="logo logo-admin"><img src="assets/images/login/X85.png" height="55" alt="logo"></a>
                                    </div>
